...
- <img src="https://stonkwatch.app/favicon.ico" height="14"/> [Stonkwatch](https://github.com/koalazub/stonkwatch) - ASX (Australian Securities Exchange) social intelligence: multi-source sentiment (Reddit, HotCopper, X, Bluesky), AI-summarised company announcements, ATO franking-credit calculator, bot/coordination-detection scoring, trending stocks. Free for humans via API key; agents pay per-call in USDC on Base via x402. Hosted MCP at api.stonkwatch.app/mcp.
